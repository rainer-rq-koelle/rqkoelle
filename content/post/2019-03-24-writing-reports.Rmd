...
Inline equations can be placed between dollar signs \$, e.g. $A^2=A*A$.
An equation environment can be inserted with $$ dollar signs.

However, the cross-referencing for equations andassociated numbering works only reliable for **pdf** output when the equation is properly placed with an LATEX environment.
