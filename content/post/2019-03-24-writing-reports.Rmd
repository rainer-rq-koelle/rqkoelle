...
Flextable (c.f. next section) seamlessly blends in with bookdown referencing and the knitr code-chunk `tab.cap` which eases the pain of remembering different processes.
